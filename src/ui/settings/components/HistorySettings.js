    ...
    <div style={style}>
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <input
            ...
            onChange={(e) => onUpdateSetting({name: settings["daysToKeep"].name, value: e.target.value, id: settings["daysToKeep"].id})}
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <Tooltip
            text={"WARNING: This will also clear your domain as well. So make a backup of them!"}
          />
        </div>
      </div>
