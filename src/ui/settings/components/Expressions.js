...
const RemoveButtonColumn = ({id, onRemoveExpression}) => (
  <td onClick={() => onRemoveExpression({id})}><i className="fa fa-times" aria-hidden="true"></i></td>
)
      ...
      <div style={style}>
        ...
        <div className="md-form">
            ...
            <input
              ...
              onKeyPress={(e) => (e.key === 'Enter') ? this.addExpressionByInput({expression: this.state.expressionInput}) : null}
              type="text"
              id="formText"
